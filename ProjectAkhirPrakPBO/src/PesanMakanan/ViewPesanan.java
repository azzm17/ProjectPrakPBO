...
public class ViewPesanan extends JFrame{
	...
	public ViewPesanan() {
		...
		tabelUtamaMinuman = new JTable(tableModel);
                ...
                tabelHeader.setBackground(Color.MAGENTA);
                tabelHeader.setForeground(Color.BLACK);
                tabelUtamaMinuman.setBackground(Color.PINK);
		...
		JTableHeader tabelHeader1 = tabelUtamaMakanan.getTableHeader();
                tabelHeader1.setBackground(Color.MAGENTA);
                tabelHeader1.setForeground(Color.BLACK);
                tabelUtamaMakanan.setBackground(Color.PINK);
                ...
                tabelHeader2.setBackground(Color.MAGENTA);
                tabelHeader2.setForeground(Color.BLACK);
                tabelPsnMinum.setBackground(Color.PINK);
		...
		tabelPsnMakan = new JTable(tableModel);
                ...
                tabelHeader3.setBackground(Color.MAGENTA);
                tabelHeader3.setForeground(Color.BLACK);
                tabelPsnMakan.setBackground(Color.PINK);
		...
		tabelkeranjang = new JTable(tableModel);
                ...
                tabelHeader4.setBackground(Color.MAGENTA);
                tabelHeader4.setForeground(Color.BLACK);
                tabelkeranjang.setBackground(Color.PINK);
		...
		tabelRiwayatPesanan = new JTable(tableModel);
                ...
                tabelHeader5.setBackground(Color.MAGENTA);
                tabelHeader5.setForeground(Color.BLACK);
                tabelRiwayatPesanan.setBackground(Color.PINK);
		...
		tabelDetailRiwayat = new JTable(tableModel);
                ...
                tabelHeader6.setBackground(Color.MAGENTA);
                tabelHeader6.setForeground(Color.BLACK);
                tabelDetailRiwayat.setBackground(Color.PINK);
	...
	public JFrame viewMenu() {
		...
		bOpenOrder.setBounds(425, 40, 120, 20);
                ...
                bOpenAdd.setBackground(Color.cyan);
                bOpenOrder.setBackground(Color.green);

		add(lminuman);
		scrollPane = new JScrollPane(tabelUtamaMinuman);
		add(scrollPane);
		lminuman.setBounds(200, 80, 90, 20);
                lminuman.setBackground(Color.CYAN);
		...
		lmakanan.setBounds(200, 330, 90, 20);
                lmakanan.setBackground(Color.green);
		...
		ldetailhistory.setBounds(550, 330, 200, 20);
                ldetailhistory.setBackground(Color.orange);
	...
	public JFrame viewTambahMenu() {
		...
		btnClearAdd.setBounds(240, 180, 100, 20);
                ...
                lPrice.setBackground(Color.CYAN);
                tfPrice.setBackground(Color.green);
                lCategories.setBackground(Color.CYAN);
                
                btnAddMenu.setBackground(Color.ORANGE);
	...
	public JFrame newOrder() {
		...
		lmakanan.setBackground(Color.ORANGE);
		...
		keranjang.setBounds(590, 230, 90, 20);
                keranjang.setBackground(Color.green);
		...
		btnSelesaiOrder.setBounds(575, 130, 100, 20);
                btnSelesaiOrder.setBackground(Color.green);
		btnClearOrder.setBounds(635, 170, 115, 20);
                btnClearOrder.setBackground(Color.red);
